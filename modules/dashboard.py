...
def show_dashboard():
    ...
    for ym in months:
        ...
        税額計算利益 = 最終営業利益 - インセンティブ支給総額  # インセンティブ支給総額を控除して税額計算利益を算出
        消費税額 = (
            (u10 + o10) - (u10 + o10) / 1.1 +
            (u8 + o8) - (u8 + o8) / 1.08 -
            (原価 - 原価 / 1.08) -
        ...
        法人税額 = (税額計算利益 - 消費税額) * 0.3358 if (税額計算利益 - 消費税額) > 0 else 0
    ...
    df.at["法人税額", "合計"] = (df.at["税額計算利益", "合計"] - df.at["消費税額", "合計"]) * 0.3358 if (df.at["税額計算利益", "合計"] - df.at["消費税額", "合計"]) > 0 else 70000
